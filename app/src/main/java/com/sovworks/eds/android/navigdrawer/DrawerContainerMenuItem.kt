...
class DrawerContainerMenuItem(container: EDSLocation, drawerController: DrawerControllerBase?) :
    DrawerLocationMenuItem(container, drawerController) {
    class Opener : ContainerOpenerFragment() {
        override fun onLocationOpened(location: Location) {
    ...
    override val icon: Drawable?
        get() = if (location.isOpenOrMounted())
