...
class DrawerDeviceRootMemoryItem(location: Location, drawerController: DrawerControllerBase?) :
    ...
    companion object {
        ...
        private fun getIcon(context: Context): Drawable? {
            if (_icon == null) {
                ...
                context.theme.resolveAttribute(R.attr.deviceRootIcon, typedValue, true)
